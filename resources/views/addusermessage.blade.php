  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <h3 class="section-subheading text-muted">You have successfully added new user.</h3>
      </div>
    </div>
        ...
        <form id="contactForm" name="sentMessage" novalidate>
          <div class="row">
            ...
            <div class="col-lg-12 text-center">
              ...
              <a href='{{ URL::to("/newuser")}}'><button id="dashboard" class="btn btn-primary btn-xl text-uppercase" type="button">Add New User</button></a>
